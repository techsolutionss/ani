(function($) {
    ...
    if($('.menu-nav-btn').length){
        //Show Form
        $('.menu-nav-btn').on('click', function(e) {
          e.preventDefault();
    ...
    if($('.client_review_slider').length){
    ...
    $('.single-products-images-slider').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        fade: true,
        dots: false,
        ...
        prevArrow: '<span class="pro-icon-1-prev"><i class="fa fa-angle-left"></i></span>',
        nextArrow: '<span class="pro-icon-1-next"><i class="fa fa-angle-right"></i></span>',
    ...
    $('.thumbnail-image-slider').slick({
        ...
        dots: true,
        arrows: true,
        asNavFor: '.single-products-images-slider',
        prevArrow: '<span class="pro-icon-1-prev"><i class="fa fa-angle-left"></i></span>',
        nextArrow: '<span class="pro-icon-1-next"><i class="fa fa-angle-right"></i></span>',
        focusOnSelect: true,
        responsive: [
    ...
    if ($('.banner-style-slider').length) {
        ...
        $('.banner-carousel-btn .left-btn').on('click', function() {
            $('.banner-style-slider').trigger('next.owl.carousel');
            return false;
        });
        $('.banner-carousel-btn .right-btn').on('click', function() {
            $('.banner-style-slider').trigger('prev.owl.carousel');
            return false;
        });
    }
